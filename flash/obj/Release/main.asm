...
;	.line	19; main.c	strcpy(buffer, "Bonjour tout le monde");
	MOVLW	HIGH(_main_buffer_1_31)
	MOVWF	r0x01
	MOVLW	LOW(_main_buffer_1_31)
	MOVWF	r0x00
	MOVLW	0x80
	MOVWF	r0x02
...
; ; Starting pCode block
___str_0:
	DB	0x42, 0x6f, 0x6e, 0x6a, 0x6f, 0x75, 0x72, 0x20, 0x74, 0x6f, 0x75, 0x74
	DB	0x20, 0x6c, 0x65, 0x20, 0x6d, 0x6f, 0x6e, 0x64, 0x65, 0x00
