...
; This file was generated Tue Feb 12 19:48:37 2013
;--------------------------------------------------------
...
; ; Starting pCode block
	CONFIG	PLLDIV=5,CPUDIV=OSC1_PLL2,USBDIV=2,FOSC=HSPLL_HS,VREGEN=ON,WDT=OFF,PBADEN=OFF,XINST=OFF,LVP=OFF,CP0=OFF,IESO=ON,PWRT=ON,BOR=ON
	code
